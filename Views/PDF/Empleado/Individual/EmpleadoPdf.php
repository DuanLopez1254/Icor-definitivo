...
<div class="mt-3"><br>
<center><h1 class="h3 mb-5 mt-3"><b>Lista de Empleados Inactivos</b></h1></Center>
</div>
...
<table class="table border gh">
  ...
  $conexion=mysqli_connect('localhost','root','','icor');
    $sql="SELECT * FROM registro where id_esta = 2 and Id_cargo = 3 OR Id_cargo = 2";
    ...
    <tr>
     <td><?php echo $mostrar3['id_regis'] ?></td>
      ...
      <td><?php echo $mostrar3['fecha_li'] ?></td>
    </tr>
    <?php }  ?>  
  </tbody>
</table>
